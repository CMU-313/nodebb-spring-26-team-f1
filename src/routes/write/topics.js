...
module.exports = function () {
	...
	setupApiRoute(router, 'put', '/:tid/official', [...middlewares, middleware.assert.topic], controllers.write.topics.markOfficial);
	setupApiRoute(router, 'delete', '/:tid/official', [...middlewares], controllers.write.topics.unmarkOfficial);
